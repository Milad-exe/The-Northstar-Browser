import { applyGrayscale, removeGrayscale } from './grayscale';
import { pauseMedia } from './media';
import { getFocusInjectionForUrl, getShortformInjectionForUrl } from './injections';
class FocusMode {
    state: Map<number, { active: boolean }>;   // keyed by window id
